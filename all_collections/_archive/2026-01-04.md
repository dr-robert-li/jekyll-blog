...
```
With doubly stochastic Hʳᵉˢ and uniform input:
...
├─────────────────────────────────────────────────────────────────────────┤
│  x_{l+1} = Hʳᵉˢ × x_l + Hᵖᵒˢᵗ × F(Hᵖʳᵉ × x_l)                         │
│                                                                         │
...
│              MANIFOLD-CONSTRAINED HYPER-CONNECTIONS (mHC)               │
├─────────────────────────────────────────────────────────────────────────┤
│  x_{l+1} = P_M(Hʳᵉˢ) × x_l + Hᵖᵒˢᵗ × F(Hᵖʳᵉ × x_l)                    │
│            ─────────                                                    │
...
Layer 1    Layer 2    Layer 3         Layer 30
  │          │          │               │
  ▼          ▼          ▼               ▼
P_M(Hʳᵉˢ)─▶P_M(Hʳᵉˢ)─▶P_M(Hʳᵉˢ)──▶...──▶P_M(Hʳᵉˢ)
  │          │          │               │
  ▼          ▼          ▼               ▼
...
- 60 layers: 0.98⁶⁰ = 30% of early information preserved
- 200 layers: 0.98²⁰⁰ = 2% preserved
...
*Analysis prepared from arXiv:2512.24880v1, "mHC: Manifold-Constrained Hyper-Connections" by DeepSeek-AI*